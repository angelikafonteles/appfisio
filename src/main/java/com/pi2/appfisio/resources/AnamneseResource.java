...
public class AnamneseResource {
	...
	@GetMapping(value="/{id}")
	public ResponseEntity<Anamnese> findById(@PathVariable Integer id) {
	...
	@PostMapping
	public ResponseEntity<Anamnese> insert(@Valid @RequestBody AnamneseNewDTO objDto){
		Anamnese obj = service.fromDTO(objDto);
