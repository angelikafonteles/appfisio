...
public class CondutaResource {
	...
	@PostMapping
	public ResponseEntity<Conduta> insert(@Valid @RequestBody Conduta obj){
	...
	@PutMapping(value="/{id}")
	public ResponseEntity<Conduta> update(@PathVariable Integer id, @Valid @RequestBody Conduta obj){
